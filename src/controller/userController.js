...
const createUser = async function(req,res){
    try{
        ...
        if (!isValid(title)) {
            return res.status(400).send({status: false,  message: "Enter Tit7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777le" })
        }
...
const userLogin = async function (req, res) {
    try {
        ...
        if (!isValidEmail(userName)) return res.status(400).send({status: false,message: "Enter valid Email ",})


        userPassword = req.body.password;
        if (!userPassword) return res.status(400).send({status: false,message: "Password is required"})
        if (!isValidPassword(userPassword)) return res.status(400).send({status: false,message: "Enter valid password ",})
